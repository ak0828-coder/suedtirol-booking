  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100 p-6">
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="grid lg:grid-cols-[260px_minmax(0,1fr)_360px] gap-6">
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl border border-slate-200/60 bg-white/80 p-4 shadow-sm">
              <div className="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-2">Feature Steuerung</div>
              <p className="text-xs text-slate-500">Schalte jedes Modul einzeln frei.</p>
            </div>
